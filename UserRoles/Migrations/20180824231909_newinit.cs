    ...
    public partial class newinit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypoDocumentos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PersonId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Aparment = table.Column<int>(nullable: false),
                    ...
                    NumeroDoc = table.Column<string>(nullable: true),
                    Street = table.Column<string>(maxLength: 50, nullable: false),
                    TypoDocumentId = table.Column<int>(nullable: true),
                    Web = table.Column<string>(maxLength: 50, nullable: true),
                    Zip = table.Column<int>(nullable: false),
                    FirstLastName = table.Column<string>(maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Personas_TypoDocumentos_TypoDocumentId",
                        column: x => x.TypoDocumentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RepresentanteId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CaracterId = table.Column<int>(nullable: false),
                    FirstLastName = table.Column<string>(maxLength: 20, nullable: false),
                    FirstName = table.Column<string>(maxLength: 20, nullable: false),
                    Id = table.Column<int>(nullable: false),
                    JuridicoPersonId = table.Column<int>(nullable: true),
                    NumeroDoc = table.Column<string>(nullable: true),
                    SecondLastName = table.Column<string>(maxLength: 20, nullable: true),
                    SecondName = table.Column<string>(maxLength: 20, nullable: true),
                    TypoDocumentId = table.Column<int>(nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Representantes_Personas_JuridicoPersonId",
                        column: x => x.JuridicoPersonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Personas_TypoDocumentId",
                table: "Personas",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Representantes_JuridicoPersonId",
                table: "Representantes",
                column: "JuridicoPersonId");
